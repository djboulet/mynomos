"""
    ...
    monthly withdrawals.  This program is largely based on Leif Roschier's
    Amortized loan calculator as noted in the license notification below.
...
block_2_params={
             ...
             'isopleth_values':[['x',1000,'x'],['x',200,'x']]
             }
...
main_params={
              ...
              'transformations':[('rotate',0.01),('scale paper',)],
                'title_str':r'How long will my money last?',
                'title_x': 17,
                'title_y': 21,
                'title_box_width': 5
              }
